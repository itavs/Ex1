...
class nEx1Test {
     ...
     */
    void testF() {
        double fx0 = Matalot.Ex1.Ex1.f(po1, 0);
    ...
    public void testArea2() {
        ...
        double area = 2.5;
        assertEquals(a1, area, Ex1.EPS*10);
        assertEquals(a2, area, Ex1.EPS*10);
    ...
    public void testArea3() {
        ...
        double x1 = Ex1.sameValue(po_a, po_b, -10, -5, Ex1.EPS*100);
        double a1 = Ex1.area(po_a, po_b, x1, 6, 50);
        double area = 58.5658;
    ...
    public void testPolynomFromPoints() {
        ...
        assertArrayEquals(result, poly, Ex1.EPS);
    }
